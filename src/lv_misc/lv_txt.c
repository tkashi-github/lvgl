 ...
 */
LV_FUNC_ATTR static uint16_t lv_txt_get_next_word(const char * txt, const lv_font_t * font,
 ...
 */
LV_FUNC_ATTR uint16_t lv_txt_get_next_line(const char * txt, const lv_font_t * font,
