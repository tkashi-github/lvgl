 ...
 */
LV_FUNC_ATTR lv_obj_t * lv_canvas_create(lv_obj_t * par, const lv_obj_t * copy)
{
 ...
 *
 */
LV_FUNC_ATTR void lv_canvas_set_buffer(lv_obj_t * canvas, void * buf, lv_coord_t w, lv_coord_t h, lv_img_cf_t cf)
{
 ...
 */
LV_FUNC_ATTR void lv_canvas_set_px(lv_obj_t * canvas, lv_coord_t x, lv_coord_t y, lv_color_t c)
{
    lv_canvas_ext_t * ext = lv_obj_get_ext_attr(canvas);
 ...
 */
LV_FUNC_ATTR void lv_canvas_set_palette(lv_obj_t * canvas, uint8_t id, lv_color_t c)
{
    lv_canvas_ext_t * ext = lv_obj_get_ext_attr(canvas);
 ...
 */
LV_FUNC_ATTR void lv_canvas_set_style(lv_obj_t * canvas, lv_canvas_style_t type, const lv_style_t * style)
{
    switch(type) {
 ...
 */
LV_FUNC_ATTR lv_color_t lv_canvas_get_px(lv_obj_t * canvas, lv_coord_t x, lv_coord_t y)
{
    lv_canvas_ext_t * ext    = lv_obj_get_ext_attr(canvas);
 ...
 */
LV_FUNC_ATTR lv_img_dsc_t * lv_canvas_get_img(lv_obj_t * canvas)
{
    lv_canvas_ext_t * ext = lv_obj_get_ext_attr(canvas);
 ...
 */
LV_FUNC_ATTR const lv_style_t * lv_canvas_get_style(const lv_obj_t * canvas, lv_canvas_style_t type)
{
 ...
 */
LV_FUNC_ATTR void lv_canvas_copy_buf(lv_obj_t * canvas, const void * to_copy, lv_coord_t x, lv_coord_t y, lv_coord_t w, lv_coord_t h)
{
    lv_canvas_ext_t * ext = lv_obj_get_ext_attr(canvas);
 ...
 */
LV_FUNC_ATTR void lv_canvas_rotate(lv_obj_t * canvas, lv_img_dsc_t * img, int16_t angle, lv_coord_t offset_x, lv_coord_t offset_y,
 ...
 */
LV_FUNC_ATTR void lv_canvas_fill_bg(lv_obj_t * canvas, lv_color_t color)
{
 ...
 */
LV_FUNC_ATTR void lv_canvas_draw_rect(lv_obj_t * canvas, lv_coord_t x, lv_coord_t y, lv_coord_t w, lv_coord_t h,
 ...
 */
LV_FUNC_ATTR void lv_canvas_draw_text(lv_obj_t * canvas, lv_coord_t x, lv_coord_t y, lv_coord_t max_w, const lv_style_t * style,
 ...
 */
LV_FUNC_ATTR void lv_canvas_draw_img(lv_obj_t * canvas, lv_coord_t x, lv_coord_t y, const void * src, const lv_style_t * style)
{
    lv_img_dsc_t * dsc = lv_canvas_get_img(canvas);
 ...
 */
LV_FUNC_ATTR void lv_canvas_draw_line(lv_obj_t * canvas, const lv_point_t * points, uint32_t point_cnt, const lv_style_t * style)
{
    lv_img_dsc_t * dsc = lv_canvas_get_img(canvas);
 ...
 */
LV_FUNC_ATTR void lv_canvas_draw_polygon(lv_obj_t * canvas, const lv_point_t * points, uint32_t point_cnt, const lv_style_t * style)
{
    lv_img_dsc_t * dsc = lv_canvas_get_img(canvas);
 ...
 * @param style style of the polygon (`body.main_color` and `body.opa` is used)
 */
LV_FUNC_ATTR void lv_canvas_draw_arc(lv_obj_t * canvas, lv_coord_t x, lv_coord_t y, lv_coord_t r, int32_t start_angle,
 ...
 */
LV_FUNC_ATTR static lv_res_t lv_canvas_signal(lv_obj_t * canvas, lv_signal_t sign, void * param)
{
    lv_res_t res;
