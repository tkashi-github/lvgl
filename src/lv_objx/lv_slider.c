 ...
 */
LV_FUNC_ATTR lv_obj_t * lv_slider_create(lv_obj_t * par, const lv_obj_t * copy)
{
 ...
 */
LV_FUNC_ATTR void lv_slider_set_knob_in(lv_obj_t * slider, bool in)
{
 ...
 */
LV_FUNC_ATTR void lv_slider_set_style(lv_obj_t * slider, lv_slider_style_t type, const lv_style_t * style)
{
    lv_slider_ext_t * ext = lv_obj_get_ext_attr(slider);
 ...
 */
LV_FUNC_ATTR int16_t lv_slider_get_value(const lv_obj_t * slider)
{
    lv_slider_ext_t * ext = lv_obj_get_ext_attr(slider);
 ...
 */
LV_FUNC_ATTR bool lv_slider_is_dragged(const lv_obj_t * slider)
{
    lv_slider_ext_t * ext = lv_obj_get_ext_attr(slider);
 ...
 *         false: the knob can be out on the edges
 */
LV_FUNC_ATTR bool lv_slider_get_knob_in(const lv_obj_t * slider)
{
    lv_slider_ext_t * ext = lv_obj_get_ext_attr(slider);
 ...
 */
LV_FUNC_ATTR const lv_style_t * lv_slider_get_style(const lv_obj_t * slider, lv_slider_style_t type)
{
 ...
 */
LV_FUNC_ATTR static bool lv_slider_design(lv_obj_t * slider, const lv_area_t * mask, lv_design_mode_t mode)
{
 ...
 */
LV_FUNC_ATTR static lv_res_t lv_slider_signal(lv_obj_t * slider, lv_signal_t sign, void * param)
{
    lv_res_t res;
